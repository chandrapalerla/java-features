...
public class TestDataUtility {
    public static List<EmployeeBean> getEmployeeData() {
        ...
        employeeBeanList.add(new EmployeeBean(13, "onac", "centrl", 65600.67, "onac@yahoo.com"));
    ...
    public static Map<EmployeeBean, Integer> getEmployeeMapData() {
        ...
        employeeBeanIntegerMap.put(new EmployeeBean(60, "umran", "Staff", 65000, "umran@gmail.com"), 13);
    ...
    public static List<User> getUserData() {
        ...
        users.add(new User("kapil", Arrays.asList(656565656, 787787878)));
